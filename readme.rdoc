...
To see some working examples, check out the {demo page}[url-to-demos].

== Basic usage.

Add these in the <tt>head</tt> element of your page:
...
If you need additional help understanding the various configuration options, check out the {live demos}[demos-url] as well as the {unit tests}[tests page url]