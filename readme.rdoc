...
I considered building this feature into the plugin but decided against it since conflicts somewhat with the general idea of keeping things random. But if you're looking to prevent overlapping it's pretty simple.

First, add the normal scripts to your header. 

  <script src="lib/jquery.local.js" type="text/javascript"></script>
  <script src="lib/jquery.masonary.js" type="text/javascript"></script>
  <script src="src/jquery.splatter.js" type="text/javascript"></script>

Notice we're also adding {jquery.masonary.js}[http://masonry.desandro.com/], so be sure to include this plugin as well.
...
http://coryschires-blog-post-images.s3.amazonaws.com/splatter/no_overlap_splatter.jpg
